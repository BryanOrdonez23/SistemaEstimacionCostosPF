...
function CambioPassAdmin() {
    ...
    const navigate = useNavigate();
      ...
      const {changePasswordAdmin} = useAdmin();
  
    const onSubmit = async (data) => {
     const res = await changePasswordAdmin(params.id, data);
     if (res) {
    ...
    const routes = [
      ...
      { path: `/administrador/admins`, displayName: 'Administrar Usuarios' },
      { path: `/administrador/admins/cambio/${params.id}`, displayName: 'Cambio de contraseña' },
    ];
...
export default CambioPassAdmin